...
import { getStockfish } from '../services/stockfish-singleton';
...
export const useStockfish = (): UseStockfishHook => {
  ...
  const stockfishRef = useRef<ReturnType<typeof getStockfish> | undefined>(undefined);
