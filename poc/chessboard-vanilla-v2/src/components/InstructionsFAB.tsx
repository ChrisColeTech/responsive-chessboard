...
export const InstructionsFAB: React.FC<InstructionsFABProps> = ({ onClick }) => {
  ...
  return (
    <button
      onClick={handleClick}
      className="absolute bottom-4 right-20 w-12 h-12 bg-primary hover:bg-primary/90 text-primary-foreground rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center group z-30"
