...
export function ActionSheet({ 
  ...
  return (
    ...
    >
      ...
      <div className="fixed bottom-[84px] left-0 right-0 md:left-0 md:right-auto md:w-80 md:bottom-[90px]">
        <DialogPanel 
          ref={panelRef}
        ...
        >
          ...
          {actions.length > 0 && <div className="border-t border-white/10 my-2"></div>}
          <ActionItem
            action={{
              id: 'open-settings',
              label: 'Settings',
