...
export function MenuButton({ isMenuOpen, onToggleMenu }: MenuButtonProps) {
  ...
  const handleMenuClick = () => {
    console.log('🔍 [MENU DEBUG] Menu button clicked, current isMenuOpen:', isMenuOpen)
  ...
  return (
    <button
      ...
      className={`w-full h-full tab-button ${isMenuOpen ? 'tab-button-active' : 'tab-button-inactive'}`}
    >
